    ...
    <div >
      ...
      <div className="flex sm:flex md:flex-row flex-col-reverse sm:px-32 px-10 items-center justify-between min-h-[calc(100dvh-4.6rem)] sm:py-24 py-10">
        <div className="md:w-1/2 w-full h-full text-left">
          ...
          <p className="courgette my-2 mb-6 sm:text-sm text-xs w-full">Love is just a click away—dive into a world where hearts connect, sparks fly, and every match is a story waiting to be written. Your perfect date is closer than you think—let’s find that magical connection together!</p>
        ...
        <div className="md:w-[400px] sm:w-[300px] w-[300px] h-auto flex items-center relative justify-center">
          <Image src="/image.png" alt="couple heart image" width={500} height={500} className=" w-full drop-shadow-xl drop-shadow-white" />
